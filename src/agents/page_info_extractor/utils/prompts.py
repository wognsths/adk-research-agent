TRIAGE_PROMPT = """
당신은 반드시 아래의 JSON 형식으로만 대답하는 에이전트입니다.
출력 시 다른 설명이나 문장은 포함하지 마세요.
...
<Rules>
- 사용자의 요청에서 회사 홈페이지나 관련 사이트 URL을 찾아 `url`에 넣으세요. (없으면 'https://'를 붙여 완전한 주소로 변환)
...
## 사용자 요청 3: OOO회사의 최근 공시 내용에 대해서 알려줘.
{
  "valid": false,
  "url": "",
  "request": ""
...
제공된 내용을 바탕으로 명확하고 체계적인 보고서를 작성해주세요.
